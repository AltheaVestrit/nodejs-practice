...
exports.getAllBooks = async () => {
    const { rows } = await pool.query("SELECT book_id, title, author, genre FROM books JOIN authors ON books.author_id=authors.author_id JOIN genres ON books.genre_id=genres.genre_id;");
    return rows;
};
